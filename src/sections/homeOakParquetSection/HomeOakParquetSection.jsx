    ...
    <section className={`section`}>
      ...
      {isMobile && (
        <p className={styles.textBottom}>
          Lorem ipsum dolor sit amet consectetur. Augue quis aliquet justo odio
          pretium vivamus arcu lobortis. Netus faucibus curabitur tellus diam
          odio pulvinar eu. Lacus lectus ultrices faucibus nec lectus odio
          dictum. Non pretium nunc felis ultricies cras.
        </p>
      )}
    </section>
  );
